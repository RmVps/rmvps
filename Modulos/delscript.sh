#!/bin/bash
clear
echo -e "\033[1;32mDESEJA DESISTALAR O NetOn MANAGER\033[1;33m"
...
if [[ "$resp" = s || "$resp" = S ]];then
    ...
    rm -rf /etc/CrashVPN > /dev/null 2>&1
    clear
    echo -e "\033[1;36mObrigado por utilizar o NetOn MANAGER\033[1;33m"
    sleep 2
