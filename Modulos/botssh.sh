...
fun_botOnOff() {
    [[ $(ps x | grep "bot_plus" | grep -v grep | wc -l) = '0' ]] && {
        clear
        echo -e "\E[44;1;37m             INSTALADOR ROBO NetOn                \E[0m\n"
        ...
        fun_bar 'fun_bot2'
        echo -e "\n\033[1;32m \033[1;31mROBO NetOn PARADO! \033[0m"
        sleep 2
        menu
    }
}
